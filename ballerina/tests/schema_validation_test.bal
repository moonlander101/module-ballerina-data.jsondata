...
function dataProviderForSchemaValidation() returns [json, json, boolean, string][] {
    [json, json, boolean, string][] testData = [];
...
isolated function testSchemaValidation(json inputData, json schema, boolean shouldPass, string testCase) {
